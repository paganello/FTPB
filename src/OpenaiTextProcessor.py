...
def t_make_request_using_custom_model(text):
    ...
    instructions = dir_and_data_getters.get_settings("CUSTOM_MODEL_SYS_INSTRUCTIONS")

    custom_model = dir_and_data_getters.get_settings("CUSTOM_MODEL_NAME")

    text_processor = OpenaiTextProcessor(dir_and_data_getters.get_credentials('OPENAI_API_KEY'))
